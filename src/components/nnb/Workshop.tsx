...
import ArrowCard from "@components/nnb/WorkshopCard";
import { cn } from "@lib/utils";

type Props = {
  tags: string[];
  data: CollectionEntry<"nnb_workshop">[];
};

export default function Blog({ data, tags }: Props) {
  const [filter, setFilter] = createSignal(new Set<string>());
  const [workshop, setWorkshop] = createSignal<
    CollectionEntry<"nnb_workshop">[]
  >([]);
